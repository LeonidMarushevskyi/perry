...
public enum MessageCode {
  ...
  UNABLE_CREATE_NEW_USER("CAP-011"),
  ...
  OFFICE_ADMIN_CANNOT_UPDATE_COUNTY_ADMIN("CAP-049"),
  ...
  OFFICE_ADMIN_CANNOT_UPDATE_STATE_ADMIN("CAP-055"),
  ...
  ERROR_AT_INVITATION_RESENDING_ON_EMAIL_CHANGE("CAP-064"),
  INVALID_PHONE_FORMAT("CAP-065"),
  UNABLE_TO_DELETE_IDM_USER_AT_USER_CREATION_FAIL("CAP-066"),
  USER_CANNOT_BE_UNLOCKED("CAP-067"),
  IDM_NOTIFY_UNSUPPORTED_OPERATION("CAP-068"),
  USER_PHONE_IS_NOT_PROVIDED("CAP-069"),
  INVALID_PHONE_EXTENSION_FORMAT("CAP-070"),
  ERROR_UPDATE_USER_IN_NS_DB("CAP-071"),
  USER_NOT_FOUND_BY_ID_IN_NS_DATABASE("CAP-072"),
  INVALID_CELL_PHONE_FORMAT("CAP-073"),
  ENABELED_STATUS_CANNOT_BE_NULL("CAP-074");
